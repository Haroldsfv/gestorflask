...
app.config['MAIL_USERNAME'] = 'hfuqenevargas@gmail.com'
app.config['MAIL_PASSWORD'] = 'eqlz nxjj goos gfrl'
app.config['MAIL_USE_TLS'] = False
app.config['MAIL_USE_SSL'] = True
app.config['MAIL_DEFAULT_SENDER'] = ('Sistema de restablecimiento de contraseñas', 'hfuqenevargas@gmail.com')
mail = Mail(app)
